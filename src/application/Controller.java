...
public class Controller {
	...
	public void initialize() {
		...
		/*
		 * pane1.setStyle("-fx-background-image: url('img1.jpg')");
		 * pane2.setStyle("-fx-background-image: url('img2.jpg')");
		 * pane3.setStyle("-fx-background-image: url('img3.jpg')");
		 * pane4.setStyle("-fx-background-image: url('img4.jpg')");
		 */
